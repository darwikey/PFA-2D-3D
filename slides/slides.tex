...
% OK : modifier les caption & rajouter image lunettes anaglyphes
...
\footnotetext{\url{http://uploads.siteduzero.com/files/239001_240000/239759.jpg}}
\end{frame}
...
% % OK : MAGALI tu peux vérifier le caption et mettre ce qu'il faut, et remplacer l'image aussi
\begin{frame}
...
%------------------------------------------------
% OK: rajouter une image de lunettes
\begin{frame}
...
\url{http://fr.wikipedia.org/wiki/Lunettes_stéréoscopiques}}

\end{frame}

%------------------------------------------------

% % OK : mettre une image de flipbooks (en laissant l'animation à côté)
...
\begin{subfigure}{.3\textwidth}
  \centering
  \animategraphics[autoplay,loop,height=2cm]{18}{gifimages/ex_gif_}{00}{29}
  \caption{Animation gif\footnotemark}
  \vspace*{-1.5cm}
 \end{subfigure}
\end{figure}

\footnotetext[4]{\url{http://tracieliu.blogspot.fr/2010/08/flipbook-storyboard.html}}
...
\begin{figure}
\centering
\animategraphics[autoplay,loop,height=6.5cm]{2}{gifimages/logiciel2_gif_}{00}{49}
...
%%------------------------------------------------
%
% OK : MAGALI complexite à rajouter
\begin{frame}
...
\begin{figure}
	\centering
	\caption{(\includegraphics[scale=0.1]{lunettes.png})Comparaison des deux résultats avec un objet complexe très détaillé}
...
\begin{frame}
	...
	\begin{figure}
		\centering
		\caption{(\includegraphics[scale=0.1]{lunettes.png})Comparaison des deux résultats avec un objet simple peu détaillé}
		\begin{subfigure}{.5\textwidth}
			\centering
