...
\title[PFA 2014-2015]{PFA 2014-2015 \\ \huge De la 3D vers la 2D} % The short title appears at the bottom of every slide, the full title is only on the title page
...
%\author{Clients : Carole BLANC, Pascal DESBARATS}
%\author{Encadrant : Sylvain LOMBARDY}
