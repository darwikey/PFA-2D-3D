...
\item Objectif : visualisation et impression en 2D des objets 3D \footnotemark
\begin{figure}[b!]
\includegraphics[scale=0.2]{logolabri.jpg} % de même                    
\hspace{2cm}
...
\begin{itemize}[label=$\bullet$]
	...
	\begin{itemize}[label=$\circ$]
		\item blabla lambda expressions blabla
	\end{itemize}
	\item Interface graphique avec Qt5
	\begin{itemize}[label=$\circ$]
		\item blabla tructruc blabla
	\end{itemize}
