...
void Settings::editparameters()
{
    ...
    settings.setValue("Shortcuts/cam_zero", ui->TranslateCameraToZero_keySequenceEdit->keySequence());
...
void Settings::resetparameters()
{
    ...
    ui->TranslateCameraToZero_keySequenceEdit->setKeySequence(settings.value("Shortcuts/cam_zero",QKeySequence("Z")).value<QKeySequence>());
}
...
void Settings::shortcutstodefault()
{
    ...
    switch (ret) {
      ...
      case QMessageBox::Yes:
        ...
        ui->TranslateCameraToZero_keySequenceEdit->setKeySequence(QKeySequence("Z"));
        break;
      default:
        break;
    }
