...
\begin{figure}[h]
	...
	\caption{\label{fig:archi} Diagramme des paquetages, architecture globale du projet \protect \footnotemark }
\end{figure}
\footnotetext{Réalisé grâce au logiciel Gliffy : \url{www.gliffy.com}}

        Le paquetage Creation a été implémenté dans l'intention d'utiliser au cours du projet des outils propres aux bibliothèques Qt et OpenGL pour Qt, comme le montre la figure \ref{fig:scene}. Les classes Point et Vecteur seront alors remplacés par les classes correspondantes de Qt.

\begin{figure}[h]
	\centering      
	\includegraphics[scale=0.5]{old_scene.png}
	\caption{\label{fig:scene}  Paquetage Scene en début du projet \protect \footnotemark }
\end{figure}
\footnotetext{Réalisé grâce au logiciel Gliffy : \url{www.gliffy.com}}
...
\begin{figure}[h]
	...
	\caption{\label{fig:creation} Paquetage Création en début de projet  \protect \footnotemark}
\end{figure}
\footnotetext{Réalisé grâce au logiciel Gliffy : \url{www.gliffy.com}}
